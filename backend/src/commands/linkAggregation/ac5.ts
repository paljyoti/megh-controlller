...
export const linkAggregationAc5: LinkAggregationCommandBuilder = {
  ...
  assignPort: (target, { groupId, mode }) =>
    buildInterfaceCommand(target, `channel-group ${groupId} mode ${mode === "static" ? "manual" : mode}`),

...
export const portAc5 = {
    ...
    setDescription: (target, description) => description.trim()
    ...
    setAdminStatus: (target, status) => buildInterfaceCommand(target, status === "up" ? "no shutdown" : "shutdown"),

...
const startMQTT = () => {
    ...
    client.on("message", async (topic, message) => {
        ...
        switch (type) {
            case "first_seen":
                await firstSeenHandler(serialNumber, data);
                break;
            case "telemetry":
                await telemetryHandler(serialNumber, data);
                break;
            case "event":
                await eventHandler(serialNumber, data);
                break;
            case "status":
                await statusHandler(serialNumber, data);
                break;
            case "response":
